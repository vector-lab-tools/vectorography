...
# downloaded: this set costs ten per cent of them. The ellipsis and the euro
# were left out deliberately; between them they cost another twenty-nine fonts
# for two characters, and an ellipsis can be set as three periods.
GLYPHS = (
