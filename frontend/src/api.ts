...
export const api = {
  ...
  location: (z: number[], text: string, full = false, geometry = false,
             neighbours = 5, straight = 0) =>
    post<Location>("/api/location",
                   { z, text, full, geometry, neighbours, straight }),
  ...
  exportFont: (z: number[], family: string, style: string, format: string,
    ...
    api.download("/api/export/font",
                 { z, family, style, format, licence, author, straight },
  ...
  exportFamily: (z: number[], family: string, licence = "none", author = "",
                 straight = 0) =>
    api.download("/api/export/family", { z, family, licence, author, straight },
